...
import { afterLoginParentForm, displayAllParent, displayParentFullDetails, deleteParent } from "./parent.controller.js";
...
router.delete("/v1/:id", authenticate(["Admin", "State"]), deleteParent)
